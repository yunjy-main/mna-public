...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "rect", "corner1": [-2.25, 5.55], "corner2": [-0.95, 6.45], "instance": "XRvdd_rdl", "model": "rdl_metal", "equation": "0.1Ω"},
        ...
        {"type": "rect", "corner1": [-2.25, 2.55], "corner2": [-0.95, 3.45], "instance": "XRio_rdl", "model": "rdl_metal", "equation": "0.1Ω"},
        ...
        {"type": "rect", "corner1": [-2.25, -0.45], "corner2": [-0.95, 0.45], "instance": "XRvss_rdl", "model": "rdl_metal", "equation": "0.1Ω"},
        ...
        {"type": "rect", "corner1": [5.55, 5.55], "corner2": [6.65, 6.45], "instance": "XRDD_un1", "model": "dd_metal", "equation": "rdd(L)"},
        {"type": "port", "at": [5.55, 6.0], "text": ""},
        {"type": "port", "at": [6.65, 6.0], "text": ""},
        {"type": "resistor", "from": [5.1, 0.0], "to": "N3B"},
        {"type": "rect", "corner1": [5.55, -0.45], "corner2": [6.65, 0.45], "instance": "XRDD_dn1", "model": "dd_metal", "equation": "rdd(L)"},
...
def build_svg(x1, x2, L=350.0, op=None, layout=None):
    ...
    for e in layout.get("elements", []):
        ...
        if t == "line":
            ...
            INC = [(xa - 0.09, yb + 0.03, 'left'), (xa - 0.09, ya + 0.12, 'left'),
                   (xb - 0.11, ya + 0.12, 'right'), (xb - 0.11, yb + 0.03, 'right')]
            if e.get("instance"):
