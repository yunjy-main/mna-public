...
DEFAULT_LAYOUT = {
    ...
    "fontsize": 9,
    "nodes": {
        "IO":  {"xy": [0.6, 2.0],  "ofst": [-1.5, 0.42]},
        "N2":  {"xy": [0.6, 4.0],  "ofst": [-1.3, 0.35]},
        "N3":  {"xy": [9.05, 4.0], "ofst": [0.3, -0.78]},
        "N3B": {"xy": [9.05, 0.0], "ofst": [0.3, 0.35]},
        "OUT": {"xy": [3.0, 2.0],  "ofst": [0.0, 0.5]},
    ...
    "elements": [
        ...
        {"type": "resistor", "from": [-2.2, 4], "to": [-0.2, 4], "label": "Rvdd_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-0.2, 4], "to": "N2"},
        {"type": "resistor", "from": [-2.2, 2], "to": [-0.2, 2], "label": "Rio_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-0.2, 2], "to": "IO"},
        ...
        {"type": "dot", "at": "N2"},
        {"type": "dot", "at": [0.6, 0]},
        {"type": "line", "from": "N2", "to": [7.05, 4]},
        {"type": "resistor", "from": [7.05, 4], "to": "N3", "label": "RDD_un1 {rvdd}Ω L={L}µm", "loc": "top"},
        {"type": "resistor", "from": [7.05, 0], "to": "N3B", "label": "RDD_dn1 {rvdd}Ω", "loc": "bottom"},
        {"type": "zener", "from": "N3B", "to": "N3", "label": "Clamp x2={x2}", "loc": "bottom"},
        {"type": "dot", "at": "N3"},
        {"type": "dot", "at": "N3B"},
        {"type": "resistor", "from": "IO", "to": [2.6, 2.0], "label": "Resd 500Ω", "loc": "bottom"},
        {"type": "line", "from": [2.6, 2.0], "to": [3.4, 2.0]},
        {"type": "diode", "from": [3.4, 2.0], "to": [3.4, 4.0], "label": "D_up2", "loc": "top"},
        {"type": "diode", "from": [3.4, 0.0], "to": [3.4, 2.0], "label": "D_down2", "loc": "top"},
        {"type": "dot", "at": [3.4, 2.0]},
        {"type": "dot", "at": [3.4, 4.0]},
        {"type": "dot", "at": [3.4, 0.0]},
        {"type": "line", "from": [3.4, 2.0], "to": [5.9, 2.0]},
        {"type": "rect", "corner1": [4.2, 0.3], "corner2": [6.25, 3.7], "title": "Victim"},
        {"type": "pfet", "drain": [5.9, 2.0], "label": "PMOS", "loc": "right", "rot": 180, "flip": True, "rail_y": 4.0},
        {"type": "nfet", "drain": [5.9, 2.0], "label": "NMOS", "loc": "right", "rot": 180, "flip": True, "rail_y": 0.0},
        {"type": "gates", "tie": "OUT"},
        {"type": "dot", "at": [5.9, 2.0]},
        {"type": "dot", "at": [5.9, 4.0]},
        {"type": "dot", "at": [5.9, 0.0]},
        {"type": "port", "at": [4.2, 2.0], "text": "IN", "lofst": [-0.7, -0.6]},
        {"type": "port", "at": [5.9, 3.7], "text": "VDD", "lofst": [0.15, 0.05]},
        {"type": "port", "at": [5.9, 0.3], "text": "VSS", "lofst": [0.15, 0.15]},
        ...
        {"type": "line", "from": [11.45, 2], "to": [12.25, 2]},
        {"type": "port", "at": [12.25, 2.0], "text": "IO2", "lofst": [0.6, 0]},
        {"type": "line", "from": [11.45, 4], "to": [12.25, 4]},
        {"type": "port", "at": [12.25, 4.0], "text": "VDD2", "lofst": [0.65, 0]},
    ],
    "current_labels": {"i": [1.6, 1.6], "iv": [3.0, 1.3]},
}
