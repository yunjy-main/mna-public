...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "rect", "corner1": [-2.25, 5.55], "corner2": [-0.95, 6.45], "instance": "XRvdd_rdl", "equation": "0.1Ω"},
        ...
        {"type": "rect", "corner1": [-2.25, 2.55], "corner2": [-0.95, 3.45], "instance": "XRio_rdl", "equation": "0.1Ω"},
        ...
        {"type": "rect", "corner1": [-2.25, -0.45], "corner2": [-0.95, 0.45], "instance": "XRvss_rdl", "equation": "0.1Ω"},
        ...
        {"type": "rect", "corner1": [5.55, 5.55], "corner2": [6.65, 6.45], "instance": "XRDD_un1", "equation": "rdd(L)"},
        {"type": "port", "at": [5.55, 6.0], "text": ""},
        {"type": "port", "at": [6.65, 6.0], "text": ""},
        {"type": "resistor", "from": [5.1, 0.0], "to": "N3B"},
        {"type": "rect", "corner1": [5.55, -0.45], "corner2": [6.65, 0.45], "instance": "XRDD_dn1", "equation": "rdd(L)"},
        ...
        {"type": "rect", "corner1": [0.55, 2.55], "corner2": [1.85, 3.45], "instance": "XResd", "equation": "500Ω"},
