...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "sourcei", "from": [-4.2, -3.0], "to": [-4.2, 0]},
        {"type": "ground", "at": [-4.2, -3.0]},
        {"type": "dot", "at": [-4.2, 6]},
        {"type": "dot", "at": [-4.2, 3]},
        {"type": "dot", "at": [-4.2, 0]},
        {"type": "label", "at": [-5.35, 4.5], "text": "I_ESD (IO→VDD)"},
        {"type": "label", "at": [-5.35, 1.5], "text": "I_ESD (IO→VSS)"},
        {"type": "label", "at": [-5.35, -1.5], "text": "I_ESD (GND→VSS)"},
        ...
        {"type": "rect", "corner1": [6.5, 0.8], "corner2": [8.55, 5.2], "title": "Victim"},
        ...
        {"type": "line", "from": [14.0, 3], "to": [15.4, 3]},
        {"type": "port", "at": [15.4, 3.0], "text": "IO2", "lofst": [0.6, 0]},
        {"type": "line", "from": [14.0, 6], "to": [15.4, 6]},
