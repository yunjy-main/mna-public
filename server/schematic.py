...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "rect", "corner1": [-0.7, 3.6], "corner2": [0.3, 5.4], "title": "D_up x1={x1}"},
        {"type": "port", "at": [-0.2, 5.4], "text": ""},
        {"type": "port", "at": [-0.2, 3.6], "text": ""},
        {"type": "diode", "from": [-0.2, 0.0], "to": "IO"},
        {"type": "rect", "corner1": [-0.7, 0.6], "corner2": [0.3, 2.4], "title": "D_down"},
        {"type": "port", "at": [-0.2, 2.4], "text": ""},
        {"type": "port", "at": [-0.2, 0.6], "text": ""},
        {"type": "dot", "at": "IO"},
        {"type": "dot", "at": "N2"},
        {"type": "dot", "at": [-0.2, 0.0]},
        ...
        {"type": "rect", "corner1": [6.6, 0.6], "corner2": [7.6, 5.4], "title": "Clamp x2={x2}"},
        {"type": "port", "at": [7.1, 5.4], "text": ""},
        ...
        {"type": "rect", "corner1": [2.1, 3.6], "corner2": [3.1, 5.4], "title": "D_up2"},
        {"type": "port", "at": [2.6, 5.4], "text": ""},
        {"type": "port", "at": [2.6, 3.6], "text": ""},
        {"type": "diode", "from": [2.6, 0.0], "to": [2.6, 3.0]},
        {"type": "rect", "corner1": [2.1, 0.6], "corner2": [3.1, 2.4], "title": "D_down2"},
        {"type": "port", "at": [2.6, 2.4], "text": ""},
        {"type": "port", "at": [2.6, 0.6], "text": ""},
        {"type": "dot", "at": [2.6, 3.0]},
        {"type": "dot", "at": [2.6, 6.0]},
        {"type": "dot", "at": [2.6, 0.0]},
        {"type": "line", "from": [2.6, 3.0], "to": [5.1, 3.0]},
        {"type": "rect", "corner1": [3.4, 0.6], "corner2": [5.45, 5.4], "title": "Victim"},
        ...
        {"type": "port", "at": [5.1, 5.4], "text": "VDD", "lofst": [0.15, 0.075]},
        {"type": "port", "at": [5.1, 0.6], "text": "VSS", "lofst": [0.15, 0.225]},
        ...
        {"type": "rect", "corner1": [6.55, -2.4], "corner2": [7.65, -0.6], "title": "D_b2b_m"},
        {"type": "port", "at": [7.1, -0.6], "text": ""},
