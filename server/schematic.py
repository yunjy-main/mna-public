...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "sourcei", "from": [-3.8, 3.0], "to": [-3.8, 6.0]},
        {"type": "sourcei", "from": [-3.8, 0.0], "to": [-3.8, 3.0]},
        {"type": "sourcei", "from": [-3.8, -3.0], "to": [-3.8, 0.0]},
        {"type": "ground", "at": [-3.8, -3.0]},
        {"type": "sourcei", "from": [-3.8, -7.05], "to": [-3.8, -4.05]},
        {"type": "ground", "at": [-3.8, -7.05]},
        {"type": "line", "from": [-3.8, -4.05], "to": [-3.0, -4.05]},
        {"type": "line", "from": [-3.0, -4.05], "to": [-3.0, -3.0]},
        {"type": "dot", "at": [-3.8, 6.0]},
        {"type": "dot", "at": [-3.8, 3.0]},
        {"type": "dot", "at": [-3.8, 0.0]},
        {"type": "label", "at": [-4.95, 4.5], "text": "I_ESD (IO→VDD)"},
        {"type": "label", "at": [-4.95, 1.5], "text": "I_ESD (IO→VSS)"},
        {"type": "label", "at": [-4.95, -1.5], "text": "I_ESD (GND→VSS)"},
        {"type": "label", "at": [-4.95, -5.55], "text": "I_ESD (GND→MVSS)"},
