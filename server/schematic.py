...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "rect", "corner1": [-0.9, 3.9], "corner2": [0.5, 5.1], "instance": "XD_up", "cell": "d_up", "model": "esdvpnp", "equation": "meas(x1)", "params": {"size": "x1"}},
        {"type": "port", "at": [-0.2, 5.1], "text": ""},
        {"type": "port", "at": [-0.2, 3.9], "text": ""},
        {"type": "diode", "from": [-0.2, 0.0], "to": "N1", "fill": "black", "instance_id": "XD_down"},
        {"type": "rect", "corner1": [-0.9, 0.9], "corner2": [0.5, 2.1], "instance": "XD_down", "cell": "d_down", "model": "esdndsx", "equation": "meas(x1)", "params": {"size": "x1"}},
