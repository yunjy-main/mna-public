...
DEFAULT_LAYOUT = {
    ...
    "fontsize": 9,
    "nodes": {
        "IO":  {"xy": [0.6, 3.0],  "ofst": [-1.5, 0.42]},
        "N2":  {"xy": [0.6, 6.0],  "ofst": [-1.3, 0.35]},
        "N3":  {"xy": [9.05, 6.0], "ofst": [0.3, -0.78]},
        "N3B": {"xy": [9.05, 0.0], "ofst": [0.3, 0.35]},
        "OUT": {"xy": [3.0, 3.0],  "ofst": [0.0, 0.5]},
        "VSSR": {"xy": [1.7, 0.0], "ofst": [-0.6, 0.35]},
    },
    "elements": [
        ...
        {"type": "line", "from": [-3.8, 6], "to": [-3.0, 6]},
        {"type": "line", "from": [-3.8, 3], "to": [-3.0, 3]},
        {"type": "line", "from": [-3.8, 0], "to": [-3.0, 0]},
        {"type": "sourcei", "from": [-3.8, 3], "to": [-3.8, 6]},
        {"type": "sourcei", "from": [-3.8, 0], "to": [-3.8, 3]},
        {"type": "sourcei", "from": [-3.8, -3.0], "to": [-3.8, 0]},
        ...
        {"type": "resistor", "from": [-2.2, 6], "to": [-0.2, 6], "label": "Rvdd_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-0.2, 6], "to": "N2"},
        {"type": "resistor", "from": [-2.2, 3], "to": [-0.2, 3], "label": "Rio_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-0.2, 3], "to": "IO"},
        {"type": "resistor", "from": [-2.2, 0], "to": [-0.2, 0], "label": "Rvss_rdl 0.1Ω", "loc": "bottom"},
        {"type": "line", "from": [-0.2, 0], "to": [7.05, 0]},
        {"type": "diode", "from": "IO", "to": "N2", "label": "D_up x1={x1}", "loc": "top"},
        {"type": "diode", "from": [0.6, 0], "to": "IO", "label": "D_down", "loc": "top"},
        {"type": "dot", "at": "IO"},
        {"type": "dot", "at": "N2"},
        {"type": "dot", "at": [0.6, 0]},
        {"type": "line", "from": "N2", "to": [7.05, 6]},
        {"type": "resistor", "from": [7.05, 6], "to": "N3", "label": "RDD_un1 {rvdd}Ω L={L}µm", "loc": "top"},
        {"type": "resistor", "from": [7.05, 0], "to": "N3B", "label": "RDD_dn1 {rvdd}Ω", "loc": "bottom"},
        {"type": "zener", "from": "N3B", "to": "N3", "label": "Clamp x2={x2}", "loc": "bottom"},
        {"type": "dot", "at": "N3"},
        {"type": "dot", "at": "N3B"},
        {"type": "resistor", "from": "IO", "to": [2.6, 3.0], "label": "Resd 500Ω", "loc": "bottom"},
        {"type": "line", "from": [2.6, 3.0], "to": [3.4, 3.0]},
        {"type": "diode", "from": [3.4, 3.0], "to": [3.4, 6.0], "label": "D_up2", "loc": "top"},
        {"type": "diode", "from": [3.4, 0.0], "to": [3.4, 3.0], "label": "D_down2", "loc": "top"},
        {"type": "dot", "at": [3.4, 3.0]},
        {"type": "dot", "at": [3.4, 6.0]},
        {"type": "dot", "at": [3.4, 0.0]},
        {"type": "line", "from": [3.4, 3.0], "to": [5.9, 3.0]},
        {"type": "rect", "corner1": [4.2, 0.8], "corner2": [6.25, 5.2], "title": "Victim"},
        {"type": "pfet", "drain": [5.9, 3.0], "label": "PMOS", "loc": "right", "rot": 180, "flip": True, "rail_y": 6.0},
        {"type": "nfet", "drain": [5.9, 3.0], "label": "NMOS", "loc": "right", "rot": 180, "flip": True, "rail_y": 0.0},
        {"type": "gates", "tie": "OUT"},
        {"type": "dot", "at": [5.9, 3.0]},
        {"type": "dot", "at": [5.9, 6.0]},
        {"type": "dot", "at": [5.9, 0.0]},
        {"type": "port", "at": [4.2, 3.0], "text": "IN", "lofst": [-0.7, -0.6]},
        {"type": "port", "at": [5.9, 5.2], "text": "VDD", "lofst": [0.15, 0.05]},
        {"type": "port", "at": [5.9, 0.8], "text": "VSS", "lofst": [0.15, 0.15]},
        {"type": "line", "from": "N3B", "to": [9.85, 0]},
        {"type": "dot", "at": [9.85, 0]},
        {"type": "line", "from": [9.85, 0], "to": [9.85, 0.7]},
        {"type": "line", "from": [9.85, 0], "to": [9.85, -0.7]},
        {"type": "diode", "from": [9.85, 0.7], "to": [11.45, 0.7], "label": "D_b2b", "loc": "top"},
        {"type": "diode", "from": [11.45, -0.7], "to": [9.85, -0.7]},
        {"type": "line", "from": [11.45, 0.7], "to": [11.45, 0]},
        {"type": "line", "from": [11.45, -0.7], "to": [11.45, 0]},
        {"type": "dot", "at": [11.45, 0]},
        {"type": "line", "from": [11.45, 0], "to": [12.25, 0]},
        {"type": "port", "at": [12.25, 0.0], "text": "VSS2", "lofst": [0.65, 0]},
        {"type": "line", "from": [11.45, 3], "to": [12.25, 3]},
        {"type": "port", "at": [12.25, 3.0], "text": "IO2", "lofst": [0.6, 0]},
        {"type": "line", "from": [11.45, 6], "to": [12.25, 6]},
        {"type": "port", "at": [12.25, 6.0], "text": "VDD2", "lofst": [0.65, 0]},
    ],
    "current_labels": {"i": [1.6, 2.45], "iv": [3.0, 2.0]},
}
