...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "line", "from": [-3.8, -3.0], "to": [-3.0, -3.0]},
        {"type": "line", "from": [-3.8, 5.5], "to": [-3.8, 6.0]},
        {"type": "sourcei", "from": [-3.8, 4.5], "to": [-3.8, 5.5]},
        {"type": "ground", "at": [-3.8, 4.5]},
        {"type": "rect", "corner1": [-4.3, 4.0], "corner2": [-3.3, 5.55], "title": "I_ESD (IO→VDD)"},
        {"type": "port", "at": [-3.8, 5.55], "text": ""},
        {"type": "line", "from": [-3.8, 2.5], "to": [-3.8, 3.0]},
        {"type": "sourcei", "from": [-3.8, 1.5], "to": [-3.8, 2.5]},
        {"type": "ground", "at": [-3.8, 1.5]},
        {"type": "rect", "corner1": [-4.3, 1.0], "corner2": [-3.3, 2.55], "title": "I_ESD (IO→VSS)"},
        {"type": "port", "at": [-3.8, 2.55], "text": ""},
        {"type": "line", "from": [-3.8, -0.5], "to": [-3.8, 0.0]},
        {"type": "sourcei", "from": [-3.8, -1.5], "to": [-3.8, -0.5]},
        {"type": "ground", "at": [-3.8, -1.5]},
        {"type": "rect", "corner1": [-4.3, -2.0], "corner2": [-3.3, -0.45], "title": "I_ESD (GND→VSS)"},
        {"type": "port", "at": [-3.8, -0.45], "text": ""},
        {"type": "line", "from": [-3.8, -3.5], "to": [-3.8, -3.0]},
        {"type": "sourcei", "from": [-3.8, -4.5], "to": [-3.8, -3.5]},
        {"type": "ground", "at": [-3.8, -4.5]},
        {"type": "rect", "corner1": [-4.3, -5.0], "corner2": [-3.3, -3.45], "title": "I_ESD (GND→MVSS)"},
        {"type": "port", "at": [-3.8, -3.45], "text": ""},
        {"type": "line", "from": [-3.0, 6.0], "to": [-2.6, 6.0]},
        {"type": "resistor", "from": [-2.6, 6.0], "to": [-0.6, 6.0]},
        {"type": "rect", "corner1": [-2.25, 5.55], "corner2": [-0.95, 6.45], "title": "Rvdd_rdl 0.1Ω"},
        ...
        {"type": "rect", "corner1": [-2.25, 2.55], "corner2": [-0.95, 3.45], "title": "Rio_rdl 0.1Ω"},
        ...
        {"type": "rect", "corner1": [-2.25, -0.45], "corner2": [-0.95, 0.45], "title": "Rvss_rdl 0.1Ω"},
        ...
        {"type": "rect", "corner1": [5.55, 5.55], "corner2": [6.65, 6.45], "title": "RDD_un1 {rvdd}Ω L={L}µm"},
        {"type": "port", "at": [5.55, 6.0], "text": ""},
        {"type": "port", "at": [6.65, 6.0], "text": ""},
        {"type": "resistor", "from": [5.1, 0.0], "to": "N3B"},
        {"type": "rect", "corner1": [5.55, -0.45], "corner2": [6.65, 0.45], "title": "RDD_dn1 {rvdd}Ω"},
        ...
        {"type": "rect", "corner1": [0.55, 2.55], "corner2": [1.85, 3.45], "title": "Resd 500Ω"},
        ...
        {"type": "rect", "corner1": [6.55, -2.475], "corner2": [7.65, -0.525], "title": "D_b2b_m"},
        {"type": "port", "at": [7.1, -0.525], "text": ""},
        {"type": "port", "at": [7.1, -2.475], "text": ""},
