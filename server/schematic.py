...
DEFAULT_LAYOUT = {
    ...
    "nodes": {
        ...
        "N3":  {"xy": [8.25, 4.0], "ofst": [0.3, -0.78]},
        "N3B": {"xy": [8.25, 0.0], "ofst": [0.3, 0.35]},
    ...
    "elements": [
        ...
        {"type": "resistor", "from": [-3.0, 4], "to": [-1.0, 4], "label": "Rvdd_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-1.0, 4], "to": "N2"},
        {"type": "resistor", "from": [-3.0, 2], "to": [-1.0, 2], "label": "Rio_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-1.0, 2], "to": "IO"},
        {"type": "resistor", "from": [-3.0, 0], "to": [-1.0, 0], "label": "Rvss_rdl 0.1Ω", "loc": "bottom"},
        {"type": "line", "from": [-1.0, 0], "to": [6.25, 0]},
        {"type": "diode", "from": "IO", "to": "N2", "label": "D_up x1={x1}", "loc": "top"},
        {"type": "diode", "from": [-0.2, 0], "to": "IO", "label": "D_down", "loc": "top"},
        {"type": "dot", "at": "IO"},
        {"type": "dot", "at": "N2"},
        {"type": "dot", "at": [-0.2, 0]},
        {"type": "line", "from": "N2", "to": [6.25, 4]},
        {"type": "resistor", "from": [6.25, 4], "to": "N3", "label": "RDD_un1 {rvdd}Ω L={L}µm", "loc": "top"},
        {"type": "resistor", "from": [6.25, 0], "to": "N3B", "label": "RDD_dn1 {rvdd}Ω", "loc": "bottom"},
        ...
        {"type": "line", "from": "N3B", "to": [9.05, 0]},
        {"type": "dot", "at": [9.05, 0]},
        {"type": "line", "from": [9.05, 0], "to": [9.05, 0.7]},
        {"type": "line", "from": [9.05, 0], "to": [9.05, -0.7]},
        {"type": "diode", "from": [9.05, 0.7], "to": [10.65, 0.7], "label": "D_b2b", "loc": "top"},
        {"type": "diode", "from": [10.65, -0.7], "to": [9.05, -0.7]},
        {"type": "line", "from": [10.65, 0.7], "to": [10.65, 0]},
        {"type": "line", "from": [10.65, -0.7], "to": [10.65, 0]},
        {"type": "dot", "at": [10.65, 0]},
        {"type": "line", "from": [10.65, 0], "to": [11.45, 0]},
        {"type": "port", "at": [11.45, 0.0], "text": "VSS2", "lofst": [0.65, 0]},
        {"type": "line", "from": [10.65, 2], "to": [11.45, 2]},
        {"type": "port", "at": [11.45, 2.0], "text": "IO2", "lofst": [0.6, 0]},
        {"type": "line", "from": [10.65, 4], "to": [11.45, 4]},
        {"type": "port", "at": [11.45, 4.0], "text": "VDD2", "lofst": [0.65, 0]},
    ],
