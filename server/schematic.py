...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "line", "from": [-3.8, 6.0], "to": [-3.0, 6.0]},
        {"type": "line", "from": [-3.8, 3.0], "to": [-3.0, 3.0]},
        {"type": "line", "from": [-3.8, 0.0], "to": [-3.0, 0.0]},
        {"type": "line", "from": [-3.8, -3.0], "to": [-3.0, -3.0]},
        {"type": "sourcei", "from": [-3.8, 4.6], "to": [-3.8, 6.0]},
        {"type": "ground", "at": [-3.8, 4.6]},
        {"type": "sourcei", "from": [-3.8, 1.6], "to": [-3.8, 3.0]},
        {"type": "ground", "at": [-3.8, 1.6]},
        {"type": "sourcei", "from": [-3.8, -1.4], "to": [-3.8, 0.0]},
        {"type": "ground", "at": [-3.8, -1.4]},
        {"type": "sourcei", "from": [-3.8, -4.4], "to": [-3.8, -3.0]},
        {"type": "ground", "at": [-3.8, -4.4]},
        {"type": "label", "at": [-4.95, 5.3], "text": "I_ESD (IO→VDD)"},
        {"type": "label", "at": [-4.95, 2.3], "text": "I_ESD (IO→VSS)"},
        {"type": "label", "at": [-4.95, -0.7], "text": "I_ESD (GND→VSS)"},
        {"type": "label", "at": [-4.95, -3.7], "text": "I_ESD (GND→MVSS)"},
        {"type": "line", "from": [-3.0, 6.0], "to": [-2.6, 6.0]},
        {"type": "resistor", "from": [-2.6, 6.0], "to": [-0.6, 6.0], "label": "Rvdd_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-0.6, 6.0], "to": "N2"},
        {"type": "line", "from": [-3.0, 3.0], "to": [-2.6, 3.0]},
        {"type": "resistor", "from": [-2.6, 3.0], "to": [-0.6, 3.0], "label": "Rio_rdl 0.1Ω", "loc": "top"},
        {"type": "line", "from": [-0.6, 3.0], "to": "IO"},
        {"type": "line", "from": [-3.0, 0.0], "to": [-2.6, 0.0]},
        {"type": "resistor", "from": [-2.6, 0.0], "to": [-0.6, 0.0], "label": "Rvss_rdl 0.1Ω", "loc": "bottom"},
        {"type": "line", "from": [-0.6, 0.0], "to": [5.1, 0.0]},
        {"type": "diode", "from": "IO", "to": "N2"},
        {"type": "rect", "corner1": [-0.7, 3.45], "corner2": [0.3, 5.55], "title": "D_up x1={x1}"},
        {"type": "port", "at": [-0.2, 5.55], "text": ""},
        {"type": "port", "at": [-0.2, 3.45], "text": ""},
        {"type": "diode", "from": [-0.2, 0.0], "to": "IO"},
        {"type": "rect", "corner1": [-0.7, 0.45], "corner2": [0.3, 2.55], "title": "D_down"},
        {"type": "port", "at": [-0.2, 2.55], "text": ""},
        {"type": "port", "at": [-0.2, 0.45], "text": ""},
        {"type": "dot", "at": "IO"},
        {"type": "dot", "at": "N2"},
        {"type": "dot", "at": [-0.2, 0.0]},
        {"type": "line", "from": "N2", "to": [5.1, 6.0]},
        {"type": "resistor", "from": [5.1, 6.0], "to": "N3", "label": "RDD_un1 {rvdd}Ω L={L}µm", "loc": "top"},
        {"type": "resistor", "from": [5.1, 0.0], "to": "N3B", "label": "RDD_dn1 {rvdd}Ω", "loc": "bottom"},
        {"type": "zener", "from": "N3B", "to": "N3"},
        {"type": "rect", "corner1": [6.6, 0.45], "corner2": [7.6, 5.55], "title": "Clamp x2={x2}"},
        {"type": "port", "at": [7.1, 5.55], "text": ""},
        {"type": "port", "at": [7.1, 0.45], "text": ""},
        {"type": "dot", "at": "N3"},
        {"type": "dot", "at": "N3B"},
        {"type": "line", "from": "IO", "to": [0.2, 3.0]},
        {"type": "resistor", "from": [0.2, 3.0], "to": [2.2, 3.0], "label": "Resd 500Ω", "loc": "bottom"},
        {"type": "line", "from": [2.2, 3.0], "to": [2.6, 3.0]},
        {"type": "diode", "from": [2.6, 3.0], "to": [2.6, 6.0]},
        {"type": "rect", "corner1": [2.1, 3.45], "corner2": [3.1, 5.55], "title": "D_up2"},
        {"type": "port", "at": [2.6, 5.55], "text": ""},
        {"type": "port", "at": [2.6, 3.45], "text": ""},
        {"type": "diode", "from": [2.6, 0.0], "to": [2.6, 3.0]},
        {"type": "rect", "corner1": [2.1, 0.45], "corner2": [3.1, 2.55], "title": "D_down2"},
        {"type": "port", "at": [2.6, 2.55], "text": ""},
        {"type": "port", "at": [2.6, 0.45], "text": ""},
        {"type": "dot", "at": [2.6, 3.0]},
        {"type": "dot", "at": [2.6, 6.0]},
        {"type": "dot", "at": [2.6, 0.0]},
        {"type": "line", "from": [2.6, 3.0], "to": [5.1, 3.0]},
        {"type": "rect", "corner1": [3.4, 0.45], "corner2": [5.45, 5.55], "title": "Victim"},
        ...
        {"type": "port", "at": [5.1, 5.55], "text": "VDD", "lofst": [0.15, 0.075]},
        {"type": "port", "at": [5.1, 0.45], "text": "VSS", "lofst": [0.15, 0.225]},
        {"type": "line", "from": "N3B", "to": [7.9, 0.0]},
        {"type": "dot", "at": [7.9, 0.0]},
        {"type": "line", "from": [7.9, 0.0], "to": [8.25, 0.0]},
        {"type": "dot", "at": [8.25, 0.0]},
        {"type": "line", "from": [8.25, 0.0], "to": [8.25, 0.525]},
        {"type": "line", "from": [8.25, 0.0], "to": [8.25, -0.525]},
        {"type": "diode", "from": [8.25, 0.525], "to": [9.15, 0.525]},
        {"type": "diode", "from": [9.15, -0.525], "to": [8.25, -0.525]},
        {"type": "rect", "corner1": [8.05, -0.9], "corner2": [9.35, 0.9], "title": "D_b2b"},
        {"type": "port", "at": [8.05, 0.0], "text": ""},
        {"type": "port", "at": [9.35, 0.0], "text": ""},
        {"type": "line", "from": [9.15, 0.525], "to": [9.15, 0.0]},
        {"type": "line", "from": [9.15, -0.525], "to": [9.15, 0.0]},
        ...
        {"type": "dot", "at": [1.2, 0.0]},
        {"type": "line", "from": [1.2, 0.0], "to": [1.2, -0.825]},
        {"type": "dot", "at": [1.2, -0.825]},
        {"type": "line", "from": [1.2, -0.825], "to": [0.9, -0.825]},
        {"type": "line", "from": [1.2, -0.825], "to": [1.5, -0.825]},
        {"type": "diode", "from": [0.9, -2.175], "to": [0.9, -0.825]},
        {"type": "diode", "from": [1.5, -0.825], "to": [1.5, -2.175]},
        {"type": "rect", "corner1": [0.65, -2.475], "corner2": [1.75, -0.525], "title": "D_b2b_m"},
        {"type": "port", "at": [1.2, -0.525], "text": ""},
        {"type": "port", "at": [1.2, -2.475], "text": ""},
        {"type": "line", "from": [0.9, -2.175], "to": [1.2, -2.175]},
        {"type": "line", "from": [1.5, -2.175], "to": [1.2, -2.175]},
        {"type": "dot", "at": [1.2, -2.175]},
        {"type": "line", "from": [1.2, -2.175], "to": [1.2, -3.0]},
        {"type": "dot", "at": [1.2, -3.0]},
    ],
