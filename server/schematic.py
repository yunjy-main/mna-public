...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "dot", "at": [7.9, 0]},
        {"type": "line", "from": [7.9, 0], "to": [7.9, 0.7]},
        {"type": "line", "from": [7.9, 0], "to": [7.9, -0.7]},
        {"type": "diode", "from": [7.9, 0.7], "to": [9.5, 0.7], "label": "D_b2b", "loc": "top"},
        {"type": "diode", "from": [9.5, -0.7], "to": [7.9, -0.7]},
        {"type": "line", "from": [9.5, 0.7], "to": [9.5, 0]},
        {"type": "line", "from": [9.5, -0.7], "to": [9.5, 0]},
        {"type": "dot", "at": [9.5, 0]},
        ...
        {"type": "dot", "at": [1.2, 0.0]},
        {"type": "line", "from": [1.2, 0.0], "to": [1.2, -0.3]},
        {"type": "dot", "at": [1.2, -0.3]},
        {"type": "line", "from": [1.2, -0.3], "to": [0.6, -0.3]},
        {"type": "line", "from": [1.2, -0.3], "to": [1.8, -0.3]},
        {"type": "diode", "from": [0.6, -1.7], "to": [0.6, -0.3], "label": "D_b2b_m", "loc": "top"},
        {"type": "diode", "from": [1.8, -0.3], "to": [1.8, -1.7]},
        {"type": "line", "from": [0.6, -1.7], "to": [1.2, -1.7]},
        {"type": "line", "from": [1.8, -1.7], "to": [1.2, -1.7]},
        {"type": "dot", "at": [1.2, -1.7]},
        {"type": "line", "from": [1.2, -1.7], "to": [1.2, -2.0]},
        {"type": "dot", "at": [1.2, -2.0]},
    ],
