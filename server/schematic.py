...
DEFAULT_LAYOUT = {
    ...
    "elements": [
        ...
        {"type": "sourcei", "from": [-4.6, -2.0], "to": [-4.6, 0]},
        {"type": "line", "from": [-4.6, 0], "to": [-3.8, 0]},
        {"type": "line", "from": [-4.6, -2.0], "to": [-4.6, -4.0]},
        {"type": "line", "from": [-4.6, -4.0], "to": [-3.8, -4.0]},
        {"type": "sourcei", "from": [-3.8, -4.0], "to": [-3.8, -2.0]},
        {"type": "line", "from": [-3.8, -2.0], "to": [-3.0, -2.0]},
        {"type": "ground", "at": [-3.8, -4.0]},
        {"type": "dot", "at": [-3.8, 4]},
        {"type": "dot", "at": [-3.8, 2]},
        {"type": "dot", "at": [-3.8, 0]},
        {"type": "dot", "at": [-3.8, -4.0]},
        ...
        {"type": "label", "at": [-5.75, -1.0], "text": "I_ESD (GND→VSS)"},
        {"type": "label", "at": [-4.95, -3.0], "text": "I_ESD (GND→MVSS)"},
