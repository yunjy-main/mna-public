...
from server.model import (  # noqa: E402
    N, D1, D2, RIO, RDD_UN1, RDD_DN1, RVSS_RDL, branch, calib, corr, series_vio, sv, VofI,
)
...
def compute_all():
    ...
    I = c1["e"]["inn"] * 0.999
    add("neg/VIO/ref/0.999It2-", I * (RIO + RDD_UN1 + RDD_DN1 + RVSS_RDL) + VofI(c1["neg"], I) + VofI(c2["neg"], I), 1e-6, "abs")
